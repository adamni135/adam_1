package org.springframework.adam.common.utils.encode.base;

import java.nio.ByteBuffer;
import java.nio.CharBuffer;
import java.nio.charset.CharacterCodingException;

import org.springframework.adam.common.utils.encode.IByteToCharEncoder;
...
public abstract class ByteToCharEncoder<T extends ByteToCharEncoder<T>> extends BaseCoder<ByteBuffer, CharBuffer, T> implements IByteToCharEncoder {
	...
	/**
	 * Convenience method for {@link #code(java.nio.Buffer)}. Does not handle
	 * all desired variations by design, e.g. only encoding a portion of the
	 * input.
	 */
